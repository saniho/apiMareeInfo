...
- 🌬️ **Pression atmosphérique** : Ajout d'un capteur de pression et de ses prévisions (hPa). Compatible avec la carte [content-card-pressure-forecast](https://github.com/SNoof85/content-card-pressure-forecast).
